...
\end{equation}
trong đó $P_{tx} = 1$ W (chuẩn hóa), $\bar{n}_{TX}$ là số lần phát trung bình. Mẫu số $= $ thông lượng thực: mỗi slot tốt có $\text{util}$ khả năng gửi và tỷ lệ $1-\text{BLER}$ thành công.
