...
\begin{table}[H]
    ...
    \end{tabularx}
    \begin{flushleft}
    \small \textit{Xác minh: ngưỡng LDPC (\ref{eq:snr_thr}) cho $r=1/2$: $0{,}73$ dB. Sai lệch mô phỏng vs lý thuyết $< 0{,}1$ dB.}
    \end{flushleft}
\end{table}

\subsubsection{Phân tích}

\textbf{Độ lợi link rõ rệt.} Ở TX = 1, IR-HARQ và No HARQ cho BLER giống nhau (cùng 1 lần phát, chưa có tích lũy phân tập). Từ TX = 2 trở đi, mỗi lần phát bổ sung thêm thông tin tương hỗ mới theo phương trình (\ref{eq:ir_mi}), đường BLER dịch sang trái khoảng 2--3 dB mỗi TX. Ở TX = 4, IR-HARQ đạt BLER = $10^{-3}$ tại $-7{,}5$ dB -- độ lợi \textbf{8{,}3 dB} so với No HARQ (cần $+5{,}0$ dB).
...
\textbf{Độ lợi vs No HARQ là 12,5 dB tổng.} IR TX=4 đạt $-7{,}5$ dB trong khi No HARQ cần $+5{,}0$ dB, tổng độ lợi HARQ so với No HARQ là $12{,}5$ dB.
...
\textbf{Độ lợi năng lượng vượt trội ở SNR thấp.} Hình~\ref{fig:sim03} và Bảng~\ref{tab:sim03} cho thấy ở $E_s/N_0 = -5$ dB, No HARQ cần $\sim 10^6$ J/bit vì BLER $\approx 1$ -- gần như toàn bộ năng lượng bị lãng phí cho các gói không thành công. IR-HARQ giảm xuống còn $\sim 4 \times 10^{-3}$ J/bit, tức cải thiện \textbf{$\sim 10^9$ lần} nhờ tích lũy phân tập từ 4 TX.
...
\begin{table}[H]
    ...
    Độ lợi SNR tại BLER=$10^{-3}$ & 0 & \textbf{+8{,}3 dB} \\\hline
    $E_s/N_0$ tại BLER=$10^{-3}$ & $\approx +5{,}0$ dB & $\approx -7{,}5$ dB \\\hline
    Util (N=32, SCS 30 kHz) & 100\% & 100\% \\\hline
    $E_{\text{bit}}$ tại $-5$ dB & $\sim 10^6$ J/bit & $\sim 4\times 10^{-3}$ J/bit \\\hline
    Tỷ lệ cải thiện $E_{\text{bit}}$ & -- & \textbf{$\sim 10^9$ lần} \\\hline
    \end{tabularx}
\end{table}
...
\begin{enumerate}
    \item \textbf{IR-HARQ mang lại độ lợi link đáng kể:} 8{,}3 dB ở BLER = $10^{-3}$ so với No HARQ, nhờ tích lũy thông tin tương hỗ độc lập qua từng TX theo bất đẳng thức Jensen (\ref{eq:jensen}).
    ...
    \item \textbf{HARQ tiết kiệm $\sim 10^9$ lần năng lượng} so với No HARQ ở SNR thấp -- đặc biệt quan trọng cho IoT vệ tinh. Tại LEO 600 km với util = 100\%, IR-HARQ khai thác lợi ích này mà không mất thêm năng lượng do pipeline stall.
\end{enumerate}
