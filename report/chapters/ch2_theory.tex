...
Trong 5G NR, giao thức HARQ sử dụng N tiến trình song song (N-process pipeline) để duy trì truyền liên tục khi chờ ACK/NACK~\cite{ts38321}. Nếu không đủ tiến trình, bộ phát phải dừng chờ -- gọi là \textit{pipeline stall}.
