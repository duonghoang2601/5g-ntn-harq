...
Đồ án đã xây dựng hoàn chỉnh bộ mô phỏng Monte Carlo cho HARQ trong 5G NTN và đánh giá hệ thống qua năm chiều hiệu năng. Bốn kết luận chính:

\begin{enumerate}
    \item \textbf{HARQ mang lại lợi ích link đáng kể ở LEO:} IR-HARQ với 4 TX đạt lợi ích 8{,}3 dB so với No HARQ tại BLER = $10^{-3}$ (MCS A, K = 15 dB), nhất quán với kết quả của~\cite{tuninato2025}. IR luôn vượt CC nhờ bất đẳng thức Jensen~(\ref{eq:jensen}).
    ...
    \item \textbf{HARQ cứu nguy hiệu quả năng lượng ở SNR thấp:} Cải thiện $\sim 10^9 \times$ so với No HARQ tại $-5$ dB, quan trọng cho thiết bị IoT vệ tinh pin giới hạn. Tuy nhiên, pipeline stall ở quỹ đạo cao làm tăng $E_{\text{bit}}$ tỷ lệ $1/\text{util}$ (GEO: 17 lần so với LEO\_600).
\end{enumerate}
...
\begin{table}[H]
    ...
    LEO 600 km & IR-HARQ, max\_retx=3, SCS $\leq$ 30 kHz & util=100\%, IR cho lợi ích tối đa \\\hline
...
\begin{enumerate}
    ...
    \item \textbf{Tương quan thời gian kênh:} Mô phỏng với kênh có tương quan (Jake's model đúng) để đánh giá lợi ích phân tập trong slow-fading (UE tĩnh, $T_c \gg T_{\text{slot}}$).
