...
\begin{enumerate}
    ...
    \item \textbf{HARQ cứu nguy hiệu quả năng lượng ở SNR thấp:} Cải thiện $\sim 10^9 \times$ so với No HARQ tại $-5$ dB, quan trọng cho thiết bị IoT vệ tinh pin giới hạn. Tuy nhiên, pipeline stall ở quỹ đạo cao làm tăng $E_{\text{bit}}$ tỷ lệ $1/\text{util}$ (GEO: 17 lần so với LEO\_{600}).
\end{enumerate}
