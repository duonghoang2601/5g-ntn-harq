...
Công trình nghiên cứu của Tuninato và cộng sự (2025)~\cite{tuninato2025} là một trong những bài báo đầu tiên phân tích hệ thống sự đánh đổi giữa HARQ và RLC ARQ trong 5G NTN. Báo cáo này được xây dựng dựa trên nền tảng đó, tập trung đánh giá IR-HARQ tại quỹ đạo LEO theo ba chiều: hiệu quả link (BLER vs SNR), ràng buộc pipeline N$_{\min}$ theo cấu hình SCS, và hiệu quả năng lượng trên bit.
